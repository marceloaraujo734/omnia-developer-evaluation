...
public static class CreateSaleMapperMock
{
    internal static Sale CommandToEntityInvalid(CreateSaleCommand command)
    {
        var sale = new Sale()
        {
    ...
    internal static Sale CommandToEntity(CreateSaleCommand command)
    {
        var sale = new Sale()
        {
            Id = Guid.NewGuid(),
    ...
    internal static CreateSaleResult EntityToResult(Sale saleMock)
    {
